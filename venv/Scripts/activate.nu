...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Delay\Desktop\replit-bounties\stocks-sentiment-scraper\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Delay\Desktop\replit-bounties\stocks-sentiment-scraper\venv\Scripts\deactivate.nu'
